...
exports.MultiEnvironmentCoordinator = void 0;
class MultiEnvironmentCoordinator {
    constructor() {
        this.environments = new Map();
        this.environmentHealth = new Map();
        this.environmentListeners = new Map();
     ...
     */
    async registerEnvironment(environment) {
     ...
     */
    async monitorEnvironmentHealth(environment, deploymentId) {
     ...
     */
    stopEnvironmentMonitoring(environment, deploymentId) {
        const monitorId = `${environment.name}-${deploymentId}`;
     ...
     */
    onSpecificEnvironmentStatusChange(environmentName, callback) {
     ...
     */
    async getDeploymentReadiness(environmentName) {
     ...
     */
    async updateEnvironmentConfig(environmentName, configUpdate) {
        const environment = this.environments.get(environmentName);
        if (!environment) {
     ...
     */
    async executeHealthCheck(endpoint, environment) {
     ...
     */
    async notifyEnvironmentStatusChange(environment, status) {
     ...
     */
    async initializeHealthMonitoring(environment) {
     ...
     * Validate environment-specific requirements
     */
    async validateEnvironmentRequirements(environment) {
     ...
     */
    async performReadinessChecks(environment, health) {
        const checks = [];
        // Health status check
        checks.push({
...
exports.MultiEnvironmentCoordinator = MultiEnvironmentCoordinator;
//# sourceMappingURL=multi-environment-coordinator.js.map