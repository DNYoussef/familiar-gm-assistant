...
exports.TalebBarbellEngine = void 0;
const events_1 = require("events");
const perf_hooks_1 = require("perf_hooks");
/**
 * Taleb Barbell Engine - Antifragile portfolio construction and management
 */
class TalebBarbellEngine extends events_1.EventEmitter {
    constructor() {
        super();
    ...
    updateMarketRegime() {
        ...
        this.marketRegime.volatility = Math.max(0.1, Math.min(0.8, this.marketRegime.volatility + volatilityChange));
        this.marketRegime.correlations = Math.max(0.2, Math.min(0.9, this.marketRegime.correlations + correlationChange));
        // Determine regime
     ...
     */
    generateTradeRecommendations(currentSafe, currentRisk, targetSafe, targetRisk) {
        const trades = [];
    ...
    // Utility methods
    calculateTotalConvexity(safeAssets, riskAssets) {
    ...
    calculateAntifragilityScore(convexity, riskAssets) {
    ...
    weightedAverage(items, property, weightProperty) {
    ...
    getTargetSafeAllocation() {
        return this.config.targetSafeAllocation;
    }
    getTargetRiskAllocation() {
    ...
    getRebalanceHistory(count = 10) {
        return this.rebalanceHistory.slice(-count);
    }
    isRunning() {
        return this.isRunning;
    }
    getAntifragilityInsights() {
        const insights = {
...
exports.TalebBarbellEngine = TalebBarbellEngine;
exports.default = TalebBarbellEngine;
//# sourceMappingURL=TalebBarbellEngine.js.map