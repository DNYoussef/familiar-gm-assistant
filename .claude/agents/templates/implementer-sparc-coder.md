...
type: general
phase: execution
category: implementer_sparc_coder
description: implementer-sparc-coder agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent implementer-sparc-coder initiated"
...
artifact_contracts:
  ...
  output: implementer-sparc-coder_output.json
