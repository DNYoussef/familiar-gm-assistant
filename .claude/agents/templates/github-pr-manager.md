...
type: general
phase: execution
category: github_pr_manager
description: github-pr-manager agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent github-pr-manager initiated"
...
artifact_contracts:
  ...
  output: github-pr-manager_output.json
