...
type: general
phase: execution
category: tdd_london_swarm
description: tdd-london-swarm agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent tdd-london-swarm initiated"
...
artifact_contracts:
  ...
  output: tdd-london-swarm_output.json
