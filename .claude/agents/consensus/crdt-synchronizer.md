...
type: general
phase: execution
category: crdt_synchronizer
description: crdt-synchronizer agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent crdt-synchronizer initiated"
...
artifact_contracts:
  ...
  output: crdt-synchronizer_output.json
