...
type: general
phase: execution
category: code_review_swarm
description: code-review-swarm agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent code-review-swarm initiated"
...
artifact_contracts:
  ...
  output: code-review-swarm_output.json
