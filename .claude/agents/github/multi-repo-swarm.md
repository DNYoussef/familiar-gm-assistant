...
type: general
phase: execution
category: multi_repo_swarm
description: multi-repo-swarm agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent multi-repo-swarm initiated"
...
artifact_contracts:
  ...
  output: multi-repo-swarm_output.json
