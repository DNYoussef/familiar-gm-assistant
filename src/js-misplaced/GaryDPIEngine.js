...
exports.GaryDPIEngine = void 0;
const events_1 = require("events");
const perf_hooks_1 = require("perf_hooks");
/**
 * Gary's DPI Engine - Advanced market analysis and position intelligence
 */
class GaryDPIEngine extends events_1.EventEmitter {
    constructor() {
        super();
        this.marketData = new Map(); // Price history
        this.signals = [];
    ...
    analyzeMarketConditions() {
        ...
        let marketRegime = 'MEAN_REVERTING';
        if (volatility > 0.06) {
    ...
    generateDPISignals() {
        ...
        if (Math.random() > 0.1)
            return signals; // 10% chance per update
        for (const [asset, prices] of this.marketData.entries()) {
...
exports.GaryDPIEngine = GaryDPIEngine;
exports.default = GaryDPIEngine;
//# sourceMappingURL=GaryDPIEngine.js.map