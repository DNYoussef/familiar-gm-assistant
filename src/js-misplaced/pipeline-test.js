...
exports.TestLogger = exports.MockSubagent = void 0;
exports.runPipelineTest = runPipelineTest;
const HivePrincess_1 = require("../../src/swarm/hierarchy/HivePrincess");
...
class MockSubagent {
    constructor(id, type, qualityLevel) {
        this.id = id;
        this.type = type;
        this.qualityLevel = qualityLevel;
    }
    async generateWork(taskId, taskDescription) {
...
exports.MockSubagent = MockSubagent;
// Main test runner
async function runPipelineTest() {
    ...
    const princess = new HivePrincess_1.HivePrincess('Development', {
        enableAudit: true,
        strictMode: true,
    ...
    for (const scenario of scenarios) {
        ...
        try {
            ...
            const work = await scenario.subagent.generateWork(`task-${Date.now()}`, `Implement ${scenario.name} feature`);
            ...
            const auditResult = await princess.auditSubagentCompletion(work.subagentId, work.taskId, work.taskDescription, work.files, work.changes, work.metadata);
            // Check results
