...
exports.EnterpriseComplianceAutomationAgent = void 0;
const events_1 = require("events");
const soc2_automation_1 = require("./frameworks/soc2-automation");
const iso27001_mapper_1 = require("./frameworks/iso27001-mapper");
const nist_ssdf_validator_1 = require("./frameworks/nist-ssdf-validator");
const audit_trail_generator_1 = require("./audit/audit-trail-generator");
const compliance_correlator_1 = require("./correlation/compliance-correlator");
const real_time_monitor_1 = require("./monitoring/real-time-monitor");
const remediation_orchestrator_1 = require("./remediation/remediation-orchestrator");
class EnterpriseComplianceAutomationAgent extends events_1.EventEmitter {
    constructor(config) {
        super();
    ...
    async initializeFrameworks() {
        try {
            ...
            this.soc2Engine = new soc2_automation_1.SOC2AutomationEngine({
            ...
            this.iso27001Mapper = new iso27001_mapper_1.ISO27001ControlMapper({
                version: '2022',
                annexAControls: true,
                automatedMapping: true,
                riskAssessment: true
            });
            this.nistSSFDValidator = new nist_ssdf_validator_1.NISTSSFDValidator({
                version: '1.1',
            ...
            this.auditTrailGenerator = new audit_trail_generator_1.AuditTrailGenerator({
                retentionDays: this.config.auditRetentionDays,
                tamperEvident: true,
                evidencePackaging: true,
                cryptographicIntegrity: true
            });
            this.complianceCorrelator = new compliance_correlator_1.ComplianceCorrelator({
                frameworks: this.config.frameworks,
                gapAnalysis: true,
                unifiedReporting: true,
                correlationMatrix: true
            });
            this.realTimeMonitor = new real_time_monitor_1.RealTimeMonitor({
            ...
            this.remediationOrchestrator = new remediation_orchestrator_1.RemediationOrchestrator({
     ...
     */
    async handleComplianceDrift(event) {
     ...
     */
    async handleControlFailure(event) {
     ...
     */
    async handleElevatedRisk(event) {
     ...
     */
    calculateOverallCompliance(correlationResults) {
     ...
     */
    assessControlCriticality(control, framework) {
...
exports.EnterpriseComplianceAutomationAgent = EnterpriseComplianceAutomationAgent;
exports.default = EnterpriseComplianceAutomationAgent;
//# sourceMappingURL=compliance-automation-agent.js.map