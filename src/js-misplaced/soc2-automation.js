...
exports.SOC2AutomationEngine = void 0;
const events_1 = require("events");
class SOC2AutomationEngine extends events_1.EventEmitter {
    constructor(config) {
        super();
     ...
     */
    async runTypeIIAssessment(config) {
        const assessmentId = `soc2-${Date.now()}`;
        const timestamp = new Date();
        this.activeAssessment = {
            assessmentId,
            timestamp,
            criteria: config.trustServicesCriteria ? Object.keys(config.trustServicesCriteria) : ['security'],
            controls: [],
     ...
     */
    async assessTrustServicesCriteria(criteria, config) {
     ...
     */
    async assessControl(control, config) {
        const assessment = {
     ...
     */
    async executeAutomatedTest(testName) {
     ...
     */
    generateControlRecommendation(control, assessment) {
     ...
     */
    getControls(criteria) {
        const allControls = Array.from(this.controls.values());
        return criteria ? allControls.filter(c => c.category === criteria) : allControls;
    }
}
exports.SOC2AutomationEngine = SOC2AutomationEngine;
exports.default = SOC2AutomationEngine;
//# sourceMappingURL=soc2-automation.js.map