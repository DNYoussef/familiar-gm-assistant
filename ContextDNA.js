...
exports.ContextDNA = void 0;
const crypto = __importStar(require("crypto"));
class ContextDNA {
    /**
     * Generate complete context DNA fingerprint
     */
    static generateFingerprint(context, sourceAgent, targetAgent) {
     ...
     */
    static generateChecksum(context) {
     ...
     */
    static generateSemanticVector(context) {
     ...
     */
    static extractSemanticFeatures(text) {
        const features = [];
     ...
     */
    static extractRelationships(context) {
        ...
        if (typeof context === 'object' && context !== null) {
            for (const [key, value] of Object.entries(context)) {
                ...
                if (typeof value === 'object' && value !== null) {
                    related.push(...Object.keys(value));
                }
     ...
     */
    static validateTransfer(originalFingerprint, currentContext, currentAgent) {
        ...
        const semanticSimilarity = this.calculateCosineSimilarity(originalFingerprint.semanticVector, currentVector);
     ...
     */
    static calculateDrift(original, current) {
        const similarity = this.calculateCosineSimilarity(original.semanticVector, current.semanticVector);
        return 1 - similarity;
    }
    /**
     ...
     */
    static detectCumulativeDegradation(transferChain) {
     ...
     */
    static generateRecoveryCheckpoint(fingerprint, context) {
     ...
     */
    static compressContext(contextStr) {
        try {
     ...
     */
    static decompressContext(compressedContext) {
        try {
...
exports.ContextDNA = ContextDNA;
ContextDNA.SEMANTIC_THRESHOLD = 0.85;
ContextDNA.CHECKSUM_ALGORITHM = 'sha256';
ContextDNA.MAX_DEGRADATION = 0.15;
exports.default = ContextDNA;
