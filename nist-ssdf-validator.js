...
exports.NISTSSFDValidator = void 0;
const events_1 = require("events");
class NISTSSFDValidator extends events_1.EventEmitter {
    constructor(config) {
        super();
     ...
     */
    initializeNISTSSFDPractices() {
        // Prepare (PO) - Prepare the Organization
        const preparePractices = [
            {
                id: 'PO.1.1',
                function: 'prepare',
                category: 'po',
     ...
     */
    async validatePractices(config) {
        ...
        try {
            ...
            for (const func of Object.keys(config.practices)) {
     ...
     */
    async assessFunction(func, functionPractices, config) {
        const practices = [];
        const gaps = [];
     ...
     */
    async assessPractice(practice, config) {
        const assessment = {
     ...
     */
    async assessImplementationTier(practice) {
     ...
     */
    async runAutomatedPracticeTests(tests) {
        const results = [];
     ...
     */
    async executeAutomatedPracticeTest(testName) {
     ...
     */
    calculateFunctionMaturityLevel(practices) {
     ...
     */
    determineFindingSeverity(practice, currentTier, targetTier) {
     ...
     */
    estimateEffort(currentTier, targetTier) {
        const gapSize = targetTier - currentTier;
        const effortMapping = {
            1: '1-2 months',
            2: '3-6 months',
     ...
     */
    identifyResourceRequirements(gaps) {
     ...
     */
    generateFunctionRecommendations(func, practices) {
     ...
     */
    generatePracticeRecommendation(practice, assessment) {
     ...
     */
    async collectPracticeEvidence(practice) {
        return practice.evidenceRequirements.map(req => `Evidence collected for ${req} - ${practice.title}`);
    }
    /**
...
exports.NISTSSFDValidator = NISTSSFDValidator;
exports.default = NISTSSFDValidator;
//# sourceMappingURL=nist-ssdf-validator.js.map