...
type: general
phase: execution
category: resource_allocator
description: resource-allocator agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent resource-allocator initiated"
...
artifact_contracts:
  ...
  output: resource-allocator_output.json
