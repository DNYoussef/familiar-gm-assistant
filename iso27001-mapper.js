...
exports.ISO27001ControlMapper = void 0;
const events_1 = require("events");
class ISO27001ControlMapper extends events_1.EventEmitter {
    constructor(config) {
        super();
    ...
    async assessControls(config) {
        ...
        try {
            ...
            for (const domain of Object.keys(config.annexA)) {
                ...
                const domainAssessment = await this.assessDomain(domain, domainConfig);
     ...
     */
    async assessDomain(domain, config) {
     ...
     */
    shouldAssessControl(control, config) {
     ...
     */
    async runAutomatedAssessment(control) {
     ...
     */
    calculateControlScore(testResults) {
     ...
     */
    generateControlRecommendation(control) {
...
exports.ISO27001ControlMapper = ISO27001ControlMapper;
exports.default = ISO27001ControlMapper;
//# sourceMappingURL=iso27001-mapper.js.map