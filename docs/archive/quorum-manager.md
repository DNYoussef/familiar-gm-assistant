...
type: general
phase: execution
category: quorum_manager
description: quorum-manager agent for SPEK pipeline
capabilities:
  - Implement capability-based voting weight assignments
priority: medium
tools_required:
  - Read
  - Write
...
hooks:
  pre: |-
    echo "[PHASE] execution agent quorum-manager initiated"
...
artifact_contracts:
  ...
  output: quorum-manager_output.json
