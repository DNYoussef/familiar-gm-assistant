...
type: general
phase: execution
category: sparc_coordinator
description: sparc-coordinator agent for SPEK pipeline
capabilities:
  - general_purpose
priority: medium
tools_required:
...
hooks:
  pre: |-
    echo "[PHASE] execution agent sparc-coordinator initiated"
...
artifact_contracts:
  ...
  output: sparc-coordinator_output.json
