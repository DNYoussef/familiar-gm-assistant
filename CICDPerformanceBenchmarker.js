...
exports.CICDPerformanceBenchmarker = void 0;
const events_1 = require("events");
const os = __importStar(require("os"));
const process = __importStar(require("process"));
class CICDPerformanceBenchmarker extends events_1.EventEmitter {
    constructor(config) {
        super();
     ...
     */
    async executeBenchmarkScenarios() {
        const results = [];
     ...
     */
    async executeDomainBenchmark(domain, scenario) {
        ...
        try {
            ...
            // Validate compliance
            const complianceMetrics = this.validateScenarioCompliance(performanceMetrics, resourceMetrics, scenario);
            // Generate optimization recommendations
            const optimization = this.generateScenarioOptimizations(performanceMetrics, resourceMetrics, scenario);
            const result = {
     ...
     */
    async generateLoad(domain, scenario) {
     ...
     */
    calculateOverhead(currentMetrics) {
     ...
     */
    validateScenarioCompliance(performance, resources, scenario) {
        ...
        const resourceCompliant = (resources.memory.used <= scenario.resourceConstraints.maxMemory &&
     ...
     */
    generateScenarioOptimizations(performance, resources, scenario) {
    ...
    calculatePerformanceGrade(results) {
        ...
        if (averageCompliance >= 95)
            return 'A+';
        if (averageCompliance >= 90)
            return 'A';
        if (averageCompliance >= 85)
            return 'B+';
        if (averageCompliance >= 80)
            return 'B';
        if (averageCompliance >= 75)
            return 'C+';
        if (averageCompliance >= 70)
            return 'C';
        return 'D';
    }
    /**
     ...
     */
    async generatePerformanceReport(results, analysis) {
...
`;
     ...
     */
    generateProductionRecommendation(analysis) {
...
exports.CICDPerformanceBenchmarker = CICDPerformanceBenchmarker;
...
//# sourceMappingURL=CICDPerformanceBenchmarker.js.map